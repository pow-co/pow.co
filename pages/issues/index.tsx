...
import { getIssue, createIssue } from '../../services/issues';
...
const RankedIssueCard = ({ origin }: ScryptRanking) => {
    ...
    return (
        <div className="">
            <IssueCard refresh={handleRefresh} methodCalls={[]} issue={issue!} />
        </div>
    );
};
    ...
    <ThreeColumnLayout>
        ...
        <div className="col-span-12 min-h-screen lg:col-span-6">
            <div className="my-5 lg:my-10">
                {loading && <Loader />} 
                {rankings?.map((rankedIssue: ScryptRanking) => <RankedIssueCard key={rankedIssue.origin} origin={rankedIssue.origin} totaldifficulty={rankedIssue.totaldifficulty} />)}
