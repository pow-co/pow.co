  ...
  return (
    <form onSubmit={handleSubmit} className="w-full px-4">
      ...
      <div className="relative">
        ...
        <input type="search" id="search-term" value={searchTerm} onChange={handleChangeSearchTerm} onKeyUp={handleKeyUp} className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-3 pl-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="Search" />
      </div>
    </form>
  );
}
