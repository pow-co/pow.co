...
const WalletProviderPopUp = ({ onClose }: WalletProviderProps) => {
  const { authenticated, wallet, setWallet } = useBitcoin()
  ...
  const handleSensiletAuth = async (e:any) => {
    try {
      e.preventDefault()
        ...
        <div className="flex ">
          ...
          {!seedInputScreen ? (<div className="flex-col max-w-sm w-[310px] p-5 rounded-lg bg-primary-100 dark:bg-primary-800">
            ...
            <button
              ...
              className={`bg-primary-200 dark:bg-primary-700 flex w-full mt-8 h-[52px] rounded-full py-2.5 px-5  items-center text-center justify-center font-semibold ${wallet === "relayx" && authenticated ? "border-2 border-primary-500" : "border-none"}`}
            >
              <svg
            ...
            <button
              ...
              className={`bg-primary-200 dark:bg-primary-700 flex w-full mt-8 h-[52px] rounded-full py-2.5 px-5 items-center text-center justify-center font-semibold ${wallet === "twetch" && authenticated ? "border-2 border-primary-500" : "border-none"}`}
            >
              <svg
                viewBox="0 0 102 110"
                fill="none"
            ...
            <button
              ...
              className={`bg-primary-200 dark:bg-primary-700 flex w-full mt-8 h-[52px] rounded-full py-2.5 px-5 items-center text-center justify-center font-semibold ${wallet === "handcash" && authenticated ? "border-2 border-primary-500" : "border-none"}`}
            >
            ...
            <button
              ...
              className={`bg-primary-200 dark:bg-primary-700 flex w-full mt-8 h-[52px] rounded-full py-2.5 px-5 items-center text-center justify-center font-semibold ${wallet === "sensilet" && authenticated ? "border-2 border-primary-500" : "border-none"}`}
            >
            ...
            <button
              ...
              className={`bg-primary-200 dark:bg-primary-700 flex w-full mt-8 h-[52px] rounded-full py-2.5 px-5 items-center text-center justify-center font-semibold ${wallet === "local" && authenticated ? "border-2 border-primary-500" : "border-none"}`}
            >
