...
const UserIcon = (props: UserIconProps) => {
  return (
    <div 
        className={`flex rounded-full items-center justify-center bg-gray-700`}
        ...
        <div className='flex items-center justify-center'>
            <div className='flex rounded-full items-center justify-center'>
                <span 
                    className={`box-border inline-block overflow-hidden bg-none opacity-100 border-none m-0 p-0 relative`}
                    style={{height:`${props.size}px`, width:`${props.size}px`, minHeight:`${props.size}px`, minWidth:`${props.size}px`}}>
                    <img 
                        src={props.src} 
