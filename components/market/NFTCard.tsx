  ...
  return (
    <div className="pt-6 pb-6 max-w-xs rounded overflow-hidden shadow-lg ml-auto mr-auto hover:bg-slate-100">
      ...
      <div className="px-6 py-6">
        <div className="font-bold text-xl text-gray-700 mb-2 hover:text-primary-300">
        <a 
        ...
        <p className="text-primary-700 text-base">{nft.description}</p>
      </div>
      <div className="px-6 pt-2 pb-2 sticky top-[100vh]">
        ...
        <span className="inline-block bg-gray-300 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2 hover:bg-primary-300">
