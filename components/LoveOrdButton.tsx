...
const LoveOrdButton = ({ txid, userPaymail }: LoveOrdButtonProps) => {
  ...
  return (
    <>
    <div onClick={inscribeLoveOrd} className='cursor-pointer flex items-center justify-center'>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 stroke-gray-500 hover:stroke-red-500 hover:fill-red-500">
