        ...
        return (
                <div className='col-span-12'>
                    ...
                    <div className='col-span-11 ml-6'>
                        ...
                        {/* </Link> */}
                        <div className='grow'/>
                        <a target="_blank" rel="noreferrer" href={`https://whatsonchain.com/tx/${post.transaction}`} className='text-xs leading-5 whitespace-nowrap text-gray-500 dark:text-gray-300 hover:text-gray-700 hover:dark:text-gray-500'>
                            {moment(post.createdAt).fromNow()}
                        </a>
                        <a href={`https://twetch.com/t/${post.transaction}`} target="_blank" rel="noreferrer" onClick={(e)=>e.stopPropagation()}>
