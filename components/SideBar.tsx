...
const SideBar = () => {
  ...
  const { authenticated, authenticate, paymail, avatar, userName } =
    useBitcoin();
  ...
  return (
    <div className="py-6 xl:p-6 items-center bg-primary-200 dark:bg-primary-800/20 w-full h-full flex flex-col">
        ...
        {authenticated ? (
          <>
            ...
            <div className="ml-3 hidden xl:block">
              <Link
                className="block truncate max-w-[100px] text-sm leading-4 font-semibold text-gray-900 dark:text-white hover:underline"
                href={`/settings`}
              >
                {userName}
              </Link>
              <Link
                className="block truncate max-w-[100px] text-xs leading-4 text-gray-500 hover:underline"
                href={`/settings`}
              >
                {paymail}
              </Link>
            ...
            <div className="hidden xl:block">
              <svg
                ...
                className="h-4 w-4 text-gray-500 hover:text-gray-700 hover:dark:text-gray-300 cursor-pointer"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
      ...
      <div className="mt-5 flex flex-col w-fit overflow-y-scroll xl:w-[calc(100%+48px)]">
        <Link href="/">
          <div className="mt-4 flex items-center cursor-pointer xl:px-5 rounded-md xl:rounded-none hover:transition-all hover:bg-primary-300 hover:dark:bg-primary-700/20 h-8 xl:h-[48px]">
            ...
            <div className="hidden xl:block text-base leading-4 grow">
        ...
        {/* <Link href={videosPath}>
                <div className='mt-4 flex items-center cursor-pointer xl:px-5 rounded-md xl:rounded-none hover:transition-all hover:bg-primary-300 hover:dark:bg-primary-700/20 h-8 xl:h-[48px]'>
                    ...
                    <div className='hidden xl:block text-base leading-4 grow'>Videos</div>
                </div>
            </Link> */}
      ...
      {authenticated && (
        <Link href="/compose">
          <button className=" w-full hidden xl:flex text-sm leading-4 text-white font-semibold mt-12 mb-6 border-none rounded-md bg-gradient-to-tr from-primary-400 to-primary-500 cursor-pointer items-center text-center justify-center py-2 px-5 transition duration-500 transform hover:-translate-y-1">
      ...
      <div className="initial xl:hidden mb-6">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-4 w-4 text-primary-600 dark:text-primary-400 hover:text-primary-700  hover:dark:text-primary-300/20 cursor-pointer"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={2}
        ...
        <div onClick={toggleTheme} className="p-3">
          <svg
            className={`cursor-pointer ${
              theme === "dark"
                ? "fill-primary-300/20 hover:fill-primary-100/20"
